...
Definition empty_set := ListSet.empty_set TransactionRequest.
...
Inductive Run : Model -> Type :=
  | empty : Run (Build_Model empty_set [] startState)
...
Definition Strategy := Run -> TransactionRequest.
(* actually, agent_strategies. No private knowledge *)
Parameter external_agents : set Strategy. 
